...
public class FaultListAdapter extends ArrayAdapter<FaultList> {
    // Your sent context
    private Context context;
    // Your custom arrayList for the spinner (User)
    private ArrayList<FaultList> arrayList;

    public FaultListAdapter(Context context, int textViewResourceId,
                              ArrayList<FaultList> arrayList) {
    ...
    @Override
    public FaultList getItem(int position){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        label.setText(arrayList.get(position).getMachine_fault());
